...
#define SSD1306_IfMode          SSD1306_IfMode_I2C // SSD1306_IfMode_SPI_4w //
...
#define SSD1306_Reset_Pin             GPIO_Pin_9
  ...
  #define SSD1306_I2C_addr              0x3C //0x3C 0x3D;   // 7-битный i2c-адрес контроллера дисплея ssd1306      
  #define SSD1306_I2C_periph            I2C1    // I2C1 или I2C2        
  #define SSD1306_I2C_clock             100000  // Частота работы I2C        
  #define SSD1306_I2C_timeout           1000 //1000    // Таймаут ожидания выполнения операций на i2c      
...
#elif (SSD1306_IfMode == SSD1306_IfMode_SPI_3w)       // Параметры работы по SPI-3w
